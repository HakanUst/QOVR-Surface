...
saveas(fig, fullfile(path, 'QOVR_Surface_Analysis_Vector_v0_all_intl_param_knots_03_05_05_07_SCLAED'), 'svg');

% Save as 300 DPI fullscreen PNG graphics
print(fig, fullfile(path, 'QOVR_Surface_Analysis_300DPI_v0_all_intl_param_knots_03_05_05_07_SCLAED'), '-dpng', '-r300', '-loose');
