...
saveas(fig, fullfile(path, 'QOVR_Surface_Analysis_Vector_v0_all_intl_param_knots_04_06_07_04_SCALED'), 'svg');

% Save as 300 DPI fullscreen PNG graphics
print(fig, fullfile(path, 'QOVR_Surface_Analysis_300DPI_v0_all_intl_param_knots_04_06_07_04_SCALED'), '-dpng', '-r300', '-loose');
