...
sur_x = xlsread(filename, sheetnum, 'N5: N10205'); 	% x Coordinates 
sur_y = xlsread(filename, sheetnum, ' O5: o10205'); 	% y Coordinates
sur_z = xlsread(filename, sheetnum, 'P5:P10205');	% z Coordinates
...
saveas(fig, fullfile(path, 'QOVR_Surface_Analysis_Vectorv0_all_intl_param_knots_05_RAW'), 'svg');

% Save as 300 DPI fullscreen PNG graphics
print(fig, fullfile(path, 'QOVR_Surface_Analysis_300DPI_v0_all_intl_param_knots_05_RAW'), '-dpng', '-r300', '-loose');
